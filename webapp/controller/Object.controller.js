...
sap.ui.define([
	...
	"use strict";
	return BaseController.extend("TestAppJS.FioriTestApp.controller.Object", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		_onBindingChange: function () {
			...
			this.addHistoryEntry({
				...
				intent: "#TestApp-display&/Customers/" + sObjectId
			});
		...
		/**
		 *@memberOf TestAppJS.FioriTestApp.controller.Object
		 */
		
		// Задание 2
		onShowDate: function (oEvent) {
			var nowDate = new Date();
			nowDate = nowDate.toString();
			MessageBox.alert(nowDate, {
				title: "Текущая дата",                                  
    			onClose: null,                                      
    			styleClass: "",                                      
    			initialFocus: null,                                  
